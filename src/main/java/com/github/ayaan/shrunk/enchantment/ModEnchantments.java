...
public class ModEnchantments {
    public static final DeferredRegister<Enchantment> ENCHANTMENTS
            = DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, ShrunkMod.MOD_ID);

    public static RegistryObject<Enchantment> JESUS_BUG =
            ENCHANTMENTS.register("lightning_striker",
                    () -> new JesusBugEnchantment(Enchantment.Rarity.UNCOMMON,
